(function() {
    ...
    mw.loader.using(['mediawiki.util', 'mediawiki.api', 'jquery.ui.dialog', 'jquery.checkboxShiftClick'], function() {
        ...
        function main() {
            ...
            html += '<option value="[[WP:RD1|RD1]]：明显侵犯版权">RD1：明显侵犯版权</option>';
            html += '<option value="[[WP:RD2|RD2]]：针对个人、团体或组织的严重侮辱、贬低或攻击性材料">RD2：针对个人、团体或组织的严重侮辱、贬低或攻击性材料</option>';
            html += '<option value="[[WP:RD3|RD3]]：纯粹的扰乱性内容">RD3：纯粹的扰乱性内容</option>';
            html += '<option value="[[WP:RD4|RD4]]：非公开的私人信息">RD4：非公开的私人信息</option>';
            html += '<option value="[[WP:RD5|RD5]]：删除守则下的有效删除，使用RevisionDelete执行">RD5：删除守则下的有效删除，使用RevisionDelete执行</option>';
            html += '<option value="[[WP:RD6|RD6]]：版本删除校正">RD6：版本删除校正</option>';
            html += '<option value="[[WP:OS|OS1]]：移除未公开私人资料">OS1：移除未公开私人资料</option>';
            html += '<option value="[[WP:OS|OS2]]：移除疑诽谤内容：维基媒体基金会要求">OS2：移除疑诽谤内容：维基媒体基金会要求</option>';
            html += '<option value="[[WP:OS|OS2]]：移除疑诽谤内容：事实清楚而且没有保留需要">OS2：移除疑诽谤内容：事实清楚而且没有保留需要</option>';
            html += '<option value="[[WP:OS|OS3]]：移除侵犯版权内容：维基媒体基金会要求">OS3：移除侵犯版权内容：维基媒体基金会要求</option>';
            html += '<option value="[[WP:OS|OS4]]：攻击性用户名">OS4：攻击性用户名</option>';
            html += '</select><br>';
            html += '刪除摘要<br>';
