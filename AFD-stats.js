if (/^Wikipedia:頁面存廢討論\/記錄\/\d+\/\d+\/\d+$/.test(mw.config.get('wgPageName'))) {
	...
	document.getElementById("toc").children[0].innerHTML+='<br>提刪:'+cntall+' <span style="color: #000000; font-weight: bold;">已關閉:'+cntcls+'</span> <span style="color: #ba0000;">需關閉:'+cntdel+'</span> <span style="color: #0b0080;">進行中:'+(cntall-cntcls-cntdel)+'</span>';
}
